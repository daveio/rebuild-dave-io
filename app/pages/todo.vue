<template>
  ...
  <div class="space-y-6">
    ...
    <div class="text-center">
      ...
      <p class="text-xl text-subtext1 mb-1">Send me a ticket in Linear</p>
      <p class="text-lg text-subtext0">Describe what you want me to do — I'll take it from there.</p>
    </div>
      ...
      <div class="card-body">
        ...
        <form class="space-y-4" @submit.prevent="onSubmit">
          ...
          <fieldset class="fieldset">
            ...
            <label class="label" for="description">What should I do? Include links, context, examples.</label>
            <textarea id="description" v-model.trim="form.description" class="textarea h-40"
