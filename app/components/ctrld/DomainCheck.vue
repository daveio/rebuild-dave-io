<template>
  <div class="domain-check-section">
    ...
    <div class="bg-surface1/50 border border-surface2 rounded-lg p-4">
      <div
        v-if="loading"
        class="flex items-center gap-2 text-subtext1 bg-{{ indicator }}"
      >
        <Icon
    ...
    <p class="text-subtext1 text-sm mt-4">The domain check operates with <strong>very limited information</strong>. It
      will
      only catch the most obvious red
      flags.</p>
  </div>
</template>
