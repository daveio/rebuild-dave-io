/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9c2fdf6e2aa092d84b219da104432f87)
// Runtime types generated with workerd@1.20250813.0 2025-08-13 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		NUXT_OPENROUTER_API_KEY: string;
		NUXT_SUPABASE_DB_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NUXT_OPENROUTER_API_KEY" | "NUXT_SUPABASE_DB_URL" | "NUXT_SUPABASE_SERVICE_KEY" | "NUXT_TURNSTILE_SECRET_KEY" | "SENTRY_AUTH_TOKEN">> {}
}
